...
struct DirectoryDigest {
  ...
  // NB: This string must be 32 bytes long! A different value is considered invalid.
...
struct ExpandDirectoriesRequest {
...
service DirectoryService {
  ExpandDirectoryResult expandDirectories(1: ExpandDirectoriesRequest expand_directories_request)
